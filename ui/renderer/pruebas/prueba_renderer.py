...
def draw_grid(matriz: Grid) -> None:
    ...
    for y in range(largo):
        ...
        for x in range(ancho): #bucle para el muro del norte
        ...
        for x in range(ancho): #bucle para los muros este-oeste
            ...
            if x == ancho - 1:
                ...
                if celda.lista & Walls.este: #Se supone que si en mi celda actual hay este en la sig hay oeste.
                    ...
                    print(" ", end="")
        print()
        if y == largo - 1: #es decir si ha llegado al final, ponemos una de mas, la parte inferior.
            print("*", end="")
